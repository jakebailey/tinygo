...
tinygo-test:
	...
	$(TINYGO) test $(TEST_ADDITIONAL_FLAGS) $(TEST_SKIP_FLAG) $(filter-out archive/zip encoding/xml $(TEST_PACKAGES_PRINTER_HOST),$(TEST_PACKAGES_HOST) $(TEST_PACKAGES_SLOW))
...
tinygo-test-fast:
	$(TINYGO) test $(TEST_SKIP_FLAG) $(filter-out archive/zip encoding/xml,$(TEST_PACKAGES_HOST))
ifneq ($(TEST_ARCHIVE_ZIP_HOST),)
