...
; Function Attrs: nounwind
define hidden i8 @main.stringMapLookupFromBytes(ptr dereferenceable_or_null(52) %m, ptr %b.data, i32 %b.len, i32 %b.cap, ptr %context) unnamed_addr #1 {
entry:
...
declare i1 @runtime.hashmapStringGet(ptr dereferenceable_or_null(52), ptr readonly, i32, ptr, i32, ptr) #0

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: readwrite)
declare void @llvm.lifetime.end.p0(ptr nocapture) #2

; Function Attrs: nounwind
define hidden i8 @main.stringMapLookupFromBytesAfterMutation(ptr dereferenceable_or_null(52) %m, ptr %b.data, i32 %b.len, i32 %b.cap, ptr %context) unnamed_addr #1 {
entry:
  %hashmap.value = alloca i8, align 1
  %stackalloc = alloca i8, align 1
